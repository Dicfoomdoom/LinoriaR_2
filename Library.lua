...
local Library = {     
    ...
    RegistryMap = {};     
    HudRegistry = {};     
    FontColor = Color3.fromRGB(192, 192, 192);
    MainColor = Color3.fromRGB(15, 15, 15);
    BackgroundColor = Color3.fromRGB(12, 12, 12);
    AccentColor = Color3.fromRGB(56, 56, 56);
    OutlineColor = Color3.fromRGB(122, 122, 122);
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local TabButtonWidth = select(1, Library:GetTextBounds(Name, Library.Font, 16));
